...
.. php:namespace:: BeastBytes\Yii\Rbam\Middleware
...
.. php:class:: AccessChecker
    ...
    .. php:method:: withRoute(string $route, array $arguments = [], array $queryParameters = [], ?string $hash = null)
        ...
        :param array $arguments: Argument-value set. Unused arguments will be moved to query parameters
            if a query parameter with the name doesn't exist
