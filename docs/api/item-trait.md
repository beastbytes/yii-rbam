# BeastBytes\Yii\Rbam\Rbac\ItemTrait

<table>
    <tr>
        <th>Implemented By</th>
        <td><a href="../item-enums">Items Enums</a></td>
    </tr>
    <tr>
        <th>Implements</th>
        <td><a href="./item-interface">BeastBytes\Yii\Rbam\Rbac\ItemInterface</a></td>
    </tr>
</table>
...
|---------------------------------------------|-----------------------|----------------------------------------------------|
| [getItemDescription()](#getitemdescription) | Returns a generated description of the RBAC item defined by an Item Enum | [BeastBytes\Yii\Rbam\Rbac\ItemTrait](./item-trait) |
| [getItemName()](#getitemname)               | Returns the fully qualified name of the RBAC item defined by an Item Enum | [BeastBytes\Yii\Rbam\Rbac\ItemTrait](./item-trait) |
