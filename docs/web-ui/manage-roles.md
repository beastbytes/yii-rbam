...
### Role
If the application defines a Guest Role it is shown with the `Empty Set` symbol (∅) in a blue circle after the name.

### Roles
RBAM Roles are shown with the `Part` symbol (∂) in a red circle after the name.

![Roles Index](../images/role_index.png)
Roles Index

## Role
The Role view page contains buttons to update the Role and manage translations,
details of the Role, and - in tabs - a [Hierarchy Diagram](./hierarchy-diagram) showing ancestors and descendants,
...
![Role View](../images/role_view.png)
Role View
...
![Manage Child Roles](../images/role_manage_child_roles.png)
Manage Child Roles
...
![Manage Permissions](../images/role_manage_permissions.png)
Manage Permissions
...
![Translate Role](../images/role_translate.png)
Translate Role
...
![Create a Role](../images/role_create.png)
Create a Role
...
![Update a Role](../images/role_update.png)
Update a Role
